...
class ActivityModelTest(TestCase):
    def test_create_activity(self):
        ...
        activity = Activity.objects.create(user=user, activity_type='run', duration=30, date='2025-06-27T00:00:00Z')
...
class WorkoutModelTest(TestCase):
    def test_create_workout(self):
        ...
        workout = Workout.objects.create(user=user, workout_type='cardio', details='30 min run', date='2025-06-27T00:00:00Z')
